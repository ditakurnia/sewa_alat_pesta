<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Form Update Data Alat Pesta</h1>
    </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="">Tipe Alat Pesta</label>
              ...
              <div class="form-group">
                ...
                <select name="sopir" id="" class="form-control">
                  <option <?php if($mb->sopir == "1"){echo "selected='selected'";} echo $mb->sopir; ?> value="1">Tersedia</option>
                  <option <?php if($mb->sopir == "0"){echo "selected='selected'";} echo $mb->sopir; ?> value="0">Tidak Tersedia</option>
                </select>
