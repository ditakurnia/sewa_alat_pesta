...
<html lang="en">
  ...
  <head>
    ...
    <title>Sewa Alat Pesta | Customer</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>Website Sewa Alat Pesta<em>.</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('customer/data_mobil') ?>">Alat Pesta</a>
              </li>
              <li class="nav-item">
